    ...
    <footer className="bg-gray-900 text-gray-300">
      <Container>
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-semibold text-xl text-white">CreativeStudio</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span>123 Creative Ave, Suite 100<br/>San Francisco, CA 94103</span>
              </li>
        ...
        <div className="py-6 border-t border-gray-800 text-sm text-center md:flex md:justify-between">
          <p>© {new Date().getFullYear()} CreativeStudio. All rights reserved.</p>
